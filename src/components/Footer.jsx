  ...
  return (
    <footer className="px-4 divide-y divide-gray-300 dark:divide-gray-600">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1 dark:text-gray-400">
              ...
              <li>
                <Link to={"AddVolunteerNeedPost"}>Add Volunteer Need Post</Link>
              </li>
              <li>
                <Link to={"ManageMyPosts"}>Manage Posts</Link>
              </li>
            </ul>
          </div>
          <div className="space-y-3">
          ...
          <div className="space-y-3">
            <h3 className="uppercase font-medium dark:text-gray-300 ">
              COMMUNITY
            </h3>
            <ul className="space-y-1 dark:text-gray-400">
              <li>
                <Link to={"AllVolunteerNeedposts"}>Join as Volunteer</Link>
              </li>
              <li>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">
        © 2025 HelpingHub. All rights reserved.
      </div>
    </footer>
  );
};
